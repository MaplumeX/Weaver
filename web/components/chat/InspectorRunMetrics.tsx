        ...
        <>
          ...
          <div className="rounded-lg border border-border/60 bg-background p-3">
            ...
            <div className="mt-3 grid grid-cols-2 gap-2">
              ...
              <div className="rounded-md border border-border/60 bg-muted/10 p-2">
                <div className="text-[11px] text-muted-foreground">Unsupported claims</div>
                <div className="mt-0.5 text-xs font-medium text-foreground tabular-nums">
                  {evidence?.unsupported_claims_count ?? 0}
                </div>
              </div>
              <div className="rounded-md border border-border/60 bg-muted/10 p-2">
                <div className="text-[11px] text-muted-foreground">Claim verifier</div>
                <div className="mt-0.5 text-xs font-medium text-foreground tabular-nums">
              ...
              <div className="rounded-md border border-border/60 bg-muted/10 p-2">
                <div className="text-[11px] text-muted-foreground">Model / route</div>
