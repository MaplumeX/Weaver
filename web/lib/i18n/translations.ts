export const translations = {
  en: {
    ...
    starterAnalyze: 'Analyze the current state of AI Agent frameworks in 2026',
    ...
    mcpPresets: 'Presets',
    mcpPresetsHint: 'Quick templates to get started. Update paths/tokens before saving.',
    mcpPresetFsMemory: 'Filesystem + Memory',
    mcpPresetGithub: 'GitHub',
    mcpPresetBraveSearch: 'Brave Search',
    mcpPresetPostgres: 'Postgres',
  ...
  zh: {
    ...
    starterAnalyze: '分析 2026 年 AI Agent 框架的现状',
    ...
    mcpPresets: '预设',
    mcpPresetsHint: '快速模板，保存前请替换路径/Token 等参数。',
  ...
  ja: {
    ...
    starterAnalyze: '2026年のAIエージェントフレームワークの現状を分析する',
    ...
    mcpPresets: 'プリセット',
    mcpPresetsHint: '開始用のテンプレートです。保存前にパス/トークン等を更新してください。',
  ...
  ko: {
    ...
    starterAnalyze: '2026년 AI 에이전트 프레임워크 현황 분석',
    ...
    mcpPresets: '프리셋',
    mcpPresetsHint: '시작용 템플릿입니다. 저장 전에 경로/토큰 등을 수정하세요.',
